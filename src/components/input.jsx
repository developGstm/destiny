  ...
  return (
    <div className="inputContainer relative">
      <input type={type} 
        ...
        />
        <label for="username" className="absolute cursor-text left-0 -top-3 text-sm text-[#ffd603] mx-1 px-1 peer-placeholder-shown:-z-10 peer-placeholder-shown:text-base peer-placeholder-shown:text-[#6f6d74] peer-placeholder-shown:top-3 peer-focus:z-10 peer-focus:-top-3 peer-focus:text-[#ffd603] peer-focus:text-sm transition-all bg-[#010417]">{placeHolder}</label>
    </div>
  )
}
